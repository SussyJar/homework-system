...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0">Assign Teacher</h2>
    ...
    <div class="col-md-8 col-lg-6">
        <div class="card">
            <div class="card-header">
                 <h5 class="mb-0">Assign Teacher for: <c:out value="${course.courseName}"/></h5>
            </div>
            <div class="card-body">
                <form action="${pageContext.request.contextPath}/admin/assign_teacher" method="post">
